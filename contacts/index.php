...
<div class="contacts">
    ...
    <div class="contacts__card">
        <div class="contacts__visit is-face">
            <div class="contacts__visit-logo"><img src="<?=SITE_TEMPLATE_PATH?>/static/images/svg/logo_brown.svg"></div>
            ...
            <form class="contacts__form">
                ...
                <div class="contacts__form-fields">
                    ...
                    <div class="contacts__form-btn-wrap">
                        <button class="contacts__form-btn btn is-brown-light" type="submit" value="send">Отправить</button>
    ...
    <div class="contacts__text">
        ...
        <div class="contacts__soc-block"><a class="contacts__soc-el icon-1s_twit"></a><a
                    class="contacts__soc-el icon-1t_skype"></a><a class="contacts__soc-el icon-1s_twit"></a><a
