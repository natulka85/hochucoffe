...
<div class="delay-page">
    ...
    <div class="page-block-head"><h1 class="page-title _type-1">Отложенные товары</h1>
        <div class="delay-page__btn js-do" data-action="delay_change" data-id="<?=implode(',',$_SESSION['bp_cache']['bp_user']['delay'])?>" data-state="Y" data-reload="Y">Очистить отложенные</div>
    </div>
