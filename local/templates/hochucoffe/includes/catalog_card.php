<?if($arParams['MOD_AJAX']==''):?><div class="catg__item <?=$arParams['MOD_ITEM_CLASS']?>" <?if($item_data!=''):?>data-block="<?=$item_data?>" <?endif;?>><?endif;?>
    ...
    <div class="catg__content">
        <div class="catg__price-block">
            <div class="catg__cur-w">
                ...
                <div class="catg__price-block-gr">
                    <?=\SaleFormatCurrency($arItem['MOD_PRICE_100_G'], 'RUB');?>/100г
                </div>
            </div>
        ...
        <div class="catg__avail-block">
            ...
            <?endif;?>
            <div class="catg__country"><?=$arItem['PROPERTIES']['_STRANA']['VALUE']?></div>
        </div>
