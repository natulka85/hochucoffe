...
define("LOG_FILENAME", $_SERVER["DOCUMENT_ROOT"]."/local/log/init.log");

//based on nf_pp https://github.com/alexxxnf/nf_pp/blob/master/nf_pp.php
function pre(){
    global $USER, $_SERVER;
...
class nf_pp {
    ...
    protected static
        ...
        $callCntr     = 0,
        $lastCallTime = 0;
    const TRACE_DEPTH = 1;  //  how many wrap functions has pp-method ( except pp-function )
